...
var updateResults = function updateResults(delta) {
...
var submitForm = function submitForm(data, location) {
...
var $colourCircle = document.getElementById('colour-circle');
var $colourId = document.getElementById('colour-id');
var $colourName = document.getElementById('colour-name');
var $colourNameForm = document.getElementById('colour-name-form');
var $colourNumber = document.getElementById('colour-number');
var $colourVisionTestPage = document.getElementById('colour-vision-test-page');
...
if ($colourCircle !== null && $colourId !== null && $colourName !== null && $colourNameForm !== null && $colourNumber !== null && $colourVisionTestPage !== null && $nextColour !== null && $responseTime !== null && $startTime !== null) {
    ...
    var updateColourCircle = function updateColourCircle() {
        fetch(COLOUR_NAME_TARGET_URL).then(function (response) {
    ...
    var updateColourResults = function updateColourResults() {
        var colour = {
            name: $colourName.value,
            value: $colourCircle.style.backgroundColor
        };
        var colours = results.colours ? [].concat(_toConsumableArray(results.colours), [colour]) : [colour];

        updateResults({ colours: colours });
    };

    updateColourCircle();

    $colourName.addEventListener('input', function () {
        if ($responseTime.value === '') {
            $responseTime.value = performance.now() - parseFloat($startTime.value);
        }
    });

    $colourNameForm.addEventListener('submit', function (event) {
        event.preventDefault();
    ...
    $colourVisionTestPage.addEventListener('click', function (event) {
        event.preventDefault();
    ...
    var dimesions = { height: window.innerHeight, width: window.innerWidth };
    ...
    window.addEventListener('resize', function () {
        ...
        if ($colourName === document.activeElement && height < dimesions.height && width === dimesions.width) {
            var _$colourName$getBound = $colourName.getBoundingClientRect(),
                inputHeight = _$colourName$getBound.height,
                top = _$colourName$getBound.top;

            var desiredScrollTop = top + scrollTop - height + inputHeight + 10;
            ...
            var forceScrollTop = function forceScrollTop() {
        ...
        dimesions = { height: height, width: width };
    });
}
...
var $genderOther = document.getElementById('gender_other');
var $experience = document.getElementById('colour_experience');
var $languageSkills = document.getElementById('language_experience');
var $educationalLevel = document.getElementById('education_level');
var $homeCountry = document.getElementById('country_raised');
var $residentCountry = document.getElementById('country_resident');
var $lightConditions = document.getElementById('ambient_light');
var $screenTemperature = document.getElementById('screen_temperature');
var $displayDevice = document.getElementById('display_device');
var $environment = document.getElementById('screen_light');
var $distance = document.getElementById('screen_distance');
...
if ($age !== null && $distance !== null && $educationalLevel !== null && $environment !== null && $experience !== null && $gender !== null && $genderOther !== null && $homeCountry !== null && $languageSkills !== null && $lightConditions !== null && $screenTemperature !== null && $residentCountry !== null && $displayDevice !== null && $thankYouPage !== null) {
    ...
    $educationalLevel.addEventListener('change', function () {
        var value = $educationalLevel.value;
    ...
    $screenTemperature.addEventListener('change', function () {
        var value = $screenTemperature.value;
    ...
    $languageSkills.addEventListener('change', function () {
        var value = $languageSkills.value;
    ...
    $lightConditions.addEventListener('change', function () {
        var value = $lightConditions.value;
    ...
    $residentCountry.addEventListener('change', function () {
        var value = $residentCountry.value;
    ...
    $displayDevice.addEventListener('change', function () {
        var value = $displayDevice.value;
    ...
    $thankYouPage.addEventListener('click', function (event) {
        event.preventDefault();
...
if ($thankYouText !== null && $results !== null) {
    var _results = results,
        colours = _results.colours;


    if (colours) {
        Promise.all(Object.keys(colours).map(function (key) {
            var _colours$key = colours[key],
                name = _colours$key.name,
                value = _colours$key.value;
            ...
            var hexColorValue = value.match(/rgb\(([0-9]+),\s([0-9]+),\s([0-9]+)\)/).slice(1).map(function (string) {
            ...
            return fetch('/namer/lang/default/name?colour=' + hexColorValue).then(function (response) {
                return response.json();
            }).then(function (json) {
